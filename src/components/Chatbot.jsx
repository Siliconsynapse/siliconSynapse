        ...
        >
          <div style={{ padding: '1rem', borderBottom: '1px solid #334155', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span className="fw-bold" style={{ color: '#3b82f6' }}>
              <i className="fas fa-robot me-2"></i>SiliconBot
            </span>
            <button
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '1rem', background: 'rgba(30,41,59,0.95)' }}>
            {messages.map((msg, idx) => (
              <div key={idx} style={{
                ...
                <div style={{
                  ...
                  maxWidth: '80%',
                  fontSize: 15,
                  boxShadow: msg.from === 'user' ? '0 2px 8px rgba(59,130,246,0.08)' : 'none'
                }}>
                  {msg.text}
                </div>
              </div>
          ...
          <form onSubmit={handleSend} style={{ display: 'flex', borderTop: '1px solid #334155', background: 'rgba(15,23,42,0.98)', borderRadius: '0 0 18px 18px' }}>
            <input
              type="text"
            ...
            />
            <button type="submit" className="btn btn-primary ms-2" style={{ borderRadius: 12 }}>
